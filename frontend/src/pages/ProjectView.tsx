...
축하의 순간, 사라지지 않게 콩! `;
  return (
    <div className="bg-[#0F1012] w-[100vw] box-sizing-border">
      <NavBar />
      <div className="w-[1200px] relative ml-auto mr-auto">
        <div className="m-[3rem_53.7rem_1.4rem_0] flex flex-col items-centerx break-words font-['Inter'] font-semibold text-[2.5rem] text-[#FFFFFF]">
          Techeer.log
        </div>
        <div className="m-[0_39.4rem_1.3rem_0] inline-block break-words font-['Inter'] font-normal text-[1.3rem] text-[#C7C7C7]">
          테커 내 모든 프로젝트를 한 번에 살펴볼 수 있는 서비스
        </div>
        <div className="bg-[#FFFFFF] absolute w-[100%] h-[0.1rem]"></div>
        <div className="m-[0_0.8rem_2.2rem_0] flex flex-row justify-between w-[100%] mt-[2.5rem] box-sizing-border">
          <div className="m-[0_0_1.6rem_0] flex flex-row box-sizing-border">
            <button className="bg-[url('./shared/assests/Icon-Like.png')] bg-[50%_50%] bg-contain bg-no-repeat m-[0_0.6rem_0_0] w-[3rem] h-[3rem]"></button>
            <div className="m-[1.1rem_0_0.9rem_0] inline-block break-words font-['Inter'] font-semibold text-[1.2rem] text-[#989898]">
              129
            </div>
          </div>
          <div className="flex flex-row justify-between box-sizing-border mt-[0.5rem]">
            <button className="bg-[url('./shared/assests/Icon-Scrap.png')] bg-[50%_50%] bg-contain bg-no-repeat m-[0_0_0_0] w-[2rem] h-[2rem]"></button>
            <button className="bg-[url('./shared/assests/Icon-Share.png')] bg-[50%_50%] bg-contain bg-no-repeat m-[0_0.6rem_0_2rem] w-[2rem] h-[2rem]"></button>
          </div>
        </div>
        <div className="flex flex-row w-[100%] justify-between box-sizing-border">
          ...
          <div className="relative m-[0.2rem_0_0_0] flex flex-col w-[23.8rem] box-sizing-border">
            <div className="relative m-[0_0_1.5rem_0] flex flex-row items-center w-[100%] box-sizing-border">
              <div className="rounded-[0.9rem] bg-[#242424] relative flex flex-col p-[2.3rem_2.3rem_1.3rem_2.3rem] w-[100%] box-sizing-border">
                <div className="m-[0_0_2.1rem_0] inline-block self-start break-words font-['Inter'] font-semibold text-[1.3rem] text-[#FFFFFF]">
                  프로젝트 정보
                </div>
                <div className="flex flex-row">
                  <div className="flex flex-col justify-between self-start w-[10rem] box-sizing-border">
                    ...
                    <div className="m-[0.1rem_0.6rem_0.2rem_0] h-16 inline-block w-[10.9rem] break-words font-['Inter'] font-semibold text-[1rem] text-[#CCCCCC]">
                      프로젝트 링크
                    </div>
                  </div>
                  <div className="flex flex-col justify-between self-start w-[17.8rem] box-sizing-border">
                    ...
                    <span className="break-words font-['Inter'] h-16 font-normal text-[1rem] text-[#FFFFFF]">웹</span>
                    <span className="break-words font-['Inter'] h-16 font-normal text-[1rem] text-[#FFFFFF]">
                      운영중
                    </span>
            ...
            <div className="rounded-[0.9rem] bg-[#242424] mb-[1.5rem] flex flex-col p-[2.3rem_1.3rem_1.3rem_2.3rem] w-[23.8rem] box-sizing-border">
              <div className="m-[0_0.2rem_1.4rem_0.2rem] inline-block self-start break-words font-['Inter'] font-semibold text-[1.3rem] text-[#FFFFFF]">
                프론트엔드
              </div>
            ...
            <div className="rounded-[0.9rem] bg-[#242424] relative flex flex-col p-[2.3rem_1.3rem_1.3rem_2.3rem] w-[100%] box-sizing-border">
              <div className="m-[0_0_2.1rem_0] inline-block self-start break-words font-['Inter'] font-semibold text-[1.3rem] text-[#FFFFFF]">
                프로젝트 팀원
              </div>
              <div className="flex flex-row">
        ...
        <div className="relative flex flex-col w-[100%] box-sizing-border">
          <div className="rounded-[0.3rem] mb-[7rem] flex flex-col w-[100%] box-sizing-border">
            <div className="m-[0_0_3.3rem_0] inline-block self-start break-words font-['Inter'] font-semibold text-[1.5rem] text-[#FFFFFF]">
              2개의 댓글
            </div>
            <input
              placeholder="댓글을 작성하세요."
              className="placeholder-white bg-transparent w-[90%] border-none m-[0_1.9rem_1.9rem_1.9rem] inline-block self-start break-words font-['Inter'] font-normal text-[1.3rem] text-[#FFFFFF]"
            ></input>
            ...
            <button className="rounded-[0.3rem] mt-[2rem] bg-[#696868] relative flex flex-row justify-center self-end p-[0.8rem_0rem_0.8rem_0] w-[8rem] box-sizing-border">
              <span className="break-words font-['Inter'] font-semibold text-[1.3rem] tracking-[0.1rem] text-[#FFFFFF]">
                댓글 작성
              </span>
            </button>
          </div>
          <div className="w-[95%] mr-auto ml-auto mb-[3rem]">
