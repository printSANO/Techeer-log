      ...
      {results.results &&
        results.results.map((res: any) => (
          ...
          >
            ...
            <div className="rounded-[0.3rem] m-[0_1rem_2.2rem_1rem] flex flex-row flex-wrap self-start w-[fit-content] box-sizing-border">
              {res.frameworkResponseList &&
                res.frameworkResponseList.map((framework: any) => (
                  <div className="rounded-[0.3rem] bg-[#333333] relative m-[0_0.3rem_0.5rem_0] flex flex-row justify-center p-[0.3rem_0.7rem_0.2rem_0.6rem] box-sizing-border">
